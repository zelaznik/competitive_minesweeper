  ...
  var prepare = window.prepare = function prepare(options) {
    ...
    imgDigits.addEventListener('load', function () {
      ...
      imgTiles.addEventListener('load', function() {
        ...
        var imgExploded = window.imgExploded = new Image();
        imgExploded.src = 'assets/exploded.png';
        imgExploded.addEventListener('load', function() {
          ...
          imgFaces.addEventListener('load', function() {
            ...
            var view = window.view = new View({
              ...
              files: { 'digits': imgDigits, 'faces': imgFaces,
              'tiles': imgTiles, 'exploded': imgExploded}
            });
            view.start();
